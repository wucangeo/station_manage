            ...
            <div class="infor-card-con">
              ...
              <Col span="16" class="height-100">
                <Row type="flex" align="middle" justify="center" class="height-100">
                  <div>
                  <p class="infor-card-count user-created-count" :style="{textAlign: 'center', color: item.color, fontSize: '30px', fontWeight: 700}"><span v-cloak id="user_created_count">{{ item.count }}</span></p>
