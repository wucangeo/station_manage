        ...
        <div class="news-title">
          ...
          <div class="news-title-button">
            <Row type="flex" justify="end">
              ...
              <Button type="primary" @click="create" icon="edit">保存</Button>
            </Row>
          </div>
        </div>
      </Card>
      ...
      <Card>
        <Row type="flex" justify="space-between">
          ...
          <span>
            ...
            <Button type="primary" @click="create" icon="edit">发布</Button>
          </span>
        </Row>
      </Card>
...
export default {
  ...
  methods: {
    async create() {
      let response = await this.apis.station.create(this.news)
